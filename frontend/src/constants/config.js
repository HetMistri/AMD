...
export const API_CONFIG = {
  ...
  BASE_URL:
    import.meta.env.VITE_API_URL || "https://amd-4gq6.onrender.com/api/v1",
...
export const ADMIN_CONFIG = {
  API_BASE_URL:
    ...
    "https://amd-4gq6.onrender.com/api/v1",
  MQTT_BROKER:
    import.meta.env.VITE_MQTT_BROKER || "wss://broker.hivemq.com:8884/mqtt",
